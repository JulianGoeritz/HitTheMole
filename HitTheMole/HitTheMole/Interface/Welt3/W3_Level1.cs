...
{
    public partial class W3_Level1 : Form
    {
        ...
        public static string Info = "Welt3 | Level1";
        public static string Schwierigkeit = "Schwer";
        ...
        private void RestZeit_Tick(object sender, EventArgs e)
        {
            ...
            if (GesamtZeit == 0)
            {
                Datenbank.Speichern(Konfiguration.SpielerName, 3, 1, Punkte);
                RestZeit.Stop();
                MoleSpawner.Stop();
                SpamCheck.Stop();
                if (Punkte < 40)
        ...
        private void W3_Level1_FormClosed(object sender, FormClosedEventArgs e)
        {
            RestZeit.Dispose();
            RestZeit = null;
            GesamtZeit = 60;
        ...
        private void W3_Level1_FormClosing(object sender, FormClosingEventArgs e)
        {
            RestZeit.Stop();
            MoleSpawner.Stop();
            SpamCheck.Stop();
