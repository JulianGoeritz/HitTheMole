...
{
    public partial class W2_Level3 : Form
    {
        ...
        private int[] Loch1 = { 68, 228 };
        private int[] Loch2 = { 269, 228 };
        private int[] Loch3 = { 468, 228 };

        private int[] Loch4 = { 68, 92 };
        private int[] Loch5 = { 269, 92 };
        private int[] Loch6 = { 468, 92 };

        // Öffentliche Informationen
        public static string Info = "Welt2 | Level3";
        public static string Schwierigkeit = "Äußerst Schwer";
        public static int LöcherAnzahl = 6;
        public static int ZeitBisZumNächstenSpawn = 600; // 0,6 sek
        ...
        private void RestZeit_Tick(object sender, EventArgs e)
        {
            ...
            if (GesamtZeit == 0)
            {
                Datenbank.Speichern(Konfiguration.SpielerName, 2, 3, Punkte);
                RestZeit.Stop();
                MoleSpawner.Stop();
                SpamCheck.Stop();
                if (Punkte < 40)
        ...
        private void W2_Level3_FormClosed(object sender, FormClosedEventArgs e)
        {
            RestZeit.Dispose();
            RestZeit = null;
            GesamtZeit = 60;
        ...
        private void W2_Level3_FormClosing(object sender, FormClosingEventArgs e)
        {
            RestZeit.Stop();
            MoleSpawner.Stop();
            SpamCheck.Stop();
