...
{
    public partial class W2_Level1 : Form
    {
        ...
        public static string Info = "Welt2 | Level1";
        public static string Schwierigkeit = "Mittelschwer";
        ...
        private void RestZeit_Tick(object sender, EventArgs e)
        {
            ...
            if (GesamtZeit == 0)
            {
                Datenbank.Speichern(Konfiguration.SpielerName, 2, 1, Punkte);
                RestZeit.Stop();
                MoleSpawner.Stop();
                SpamCheck.Stop();
                if (Punkte < 30)
        ...
        private void W2_Level1_FormClosed(object sender, FormClosedEventArgs e)
        {
            RestZeit.Dispose();
            RestZeit = null;
            GesamtZeit = 60;
        ...
        private void W2_Level1_FormClosing(object sender, FormClosingEventArgs e)
        {
            RestZeit.Stop();
            MoleSpawner.Stop();
            SpamCheck.Stop();
