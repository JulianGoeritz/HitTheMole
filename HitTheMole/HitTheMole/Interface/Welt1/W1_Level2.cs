...
{
    public partial class W1_Level2 : Form
    {
        ...
        public static string Info = "Welt1 | Level2";
        public static string Schwierigkeit = "Leicht";
        ...
        private void RestZeit_Tick(object sender, EventArgs e)
        {
            ...
            if (GesamtZeit == 0)
            {
                Datenbank.Speichern(Konfiguration.SpielerName, 1, 2, Punkte);
                RestZeit.Stop();
                MoleSpawner.Stop();
                SpamCheck.Stop();
                if (Punkte < 25)
        ...
        private void W1_Level2_FormClosing(object sender, FormClosingEventArgs e)
        {
            RestZeit.Stop();
            MoleSpawner.Stop();
            SpamCheck.Stop();
        ...
        private void W1_Level2_FormClosed(object sender, FormClosedEventArgs e)
        {
            RestZeit.Dispose();
            RestZeit = null;
            GesamtZeit = 60;
