...
{
    public partial class W1_Level3 : Form
    {
        ...
        public static string Info = "Welt1 | Level3";
        public static string Schwierigkeit = "Relativ Leicht";
        public static int LöcherAnzahl = 3;
        public static int ZeitBisZumNächstenSpawn = 600; // 0,6 sek
        public static int GesamtZeit = 60;
        ...
        private void RestZeit_Tick(object sender, EventArgs e)
        {
            ...
            if (GesamtZeit == 0)
            {
                Datenbank.Speichern(Konfiguration.SpielerName, 1, 3, Punkte);
                RestZeit.Stop();
                MoleSpawner.Stop();
                SpamCheck.Stop();
                if (Punkte < 30)
        ...
        private void W1_Level3_FormClosed(object sender, FormClosedEventArgs e)
        {
            RestZeit.Dispose();
            RestZeit = null;
            GesamtZeit = 60;
        ...
        private void W1_Level3_FormClosing(object sender, FormClosingEventArgs e)
        {
            RestZeit.Stop();
            MoleSpawner.Stop();
            SpamCheck.Stop();
